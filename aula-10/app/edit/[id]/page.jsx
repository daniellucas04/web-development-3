...
export default function Edit() {
    ...
    async function handleSubmit(event) {
        ...
        try {
            await editContact(person, phone);
    ...
    return (
        <div className="flex flex-col">
            <section className="m-12 border border-zinc-400 rounded-md p-8">
                ...
                <h1 className="text-lg font-bold text-zinc-600 my-4">Editar contato</h1>
            ...
            <section className="m-12 border border-zinc-400 rounded-md p-8">
                <h1 className="text-lg font-bold text-zinc-600 my-4">Editar números</h1>
                <form onSubmit={handleSubmit} className="flex flex-col space-y-4">
                    {/* {data.phone.map((value) => {
                        console.log(value);
                        return (
                            <span key={value}>{value.phone}</span>
                        );
                    })} */}
                </form>
            </section>
